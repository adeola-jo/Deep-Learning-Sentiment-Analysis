...
from networks import BaseLineModel, MeanPoolingLayer
...
def main(args):
    ...
    try:
        ...
        train_data = read_csv(args.train_filepath)
        val_data = read_csv(args.val_filepath)
        test_data = read_csv(args.test_filepath)
    ...
    # # train_text_frequencies = calculate_frequencies(train_data.iloc[:, 0])
    ...
    model = BaseLineModel(embedding_dim=args.embedding_dim, fc1_width=args.fc1_width, fc2_width=args.fc2_width, output_dim=args.num_classes, device=args.device, dropout_rate=args.dropout_rate)
